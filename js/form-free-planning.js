...
<a href="" class="scroll box" style="border-color:#000;text-align:-webkit-center;">
    ...
    <span class="timer" style="color:#000;font-size:14px;font-weight:600;">
        신청 마감 | <span id="day" style="font-weight:600;"></span> 
    </span>
</a></div><br><br>
    <h1 class="form-top-title">한정 혜택 신청하기</h1>
        ...
        <form action="" id="form_e11" method="POST" target="hidden_iframe11" onsubmit="dll(); submitted=true;">
            ...
            <br>
                <table class="form-box-tb">
                        ...
                        <tr id="select_lic" >
                            ...
                            <td>
                                ...
                                <select name='entry.870032759' id='division' class="form-control" placeholder="현재 조건">
                                   ...
                                   <option value="문의 구분" disabled>문의 구분</option>
                                    <option value="한정 기획 이벤트" selected>한정 기획 이벤트</option>
                    ...
                    <th>문의사항</th>
                    <td>
                        <textarea name='entry.2068120597' id='message' class="form-control" placeholder="원하시는 사항" style="min-height:100px"></textarea>
                    </td>
                </tr>
