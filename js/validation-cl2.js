$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSe-W1FGUr5rQ2KHN6rxmGoejMHHqkH6Hjw4CP0Lh8rcbauKCg/formResponse");
...
function hoa(){
    ...
    //    },1500);
    $(window).scrollTop(0);
    window.location.href="./column-2-result.html";
